...
METRICS = [
    ...
    {'name': 'download_bandwidth',
     'description': 'Speedtest Download Bandwith in bits per second (bps).',
     'type': 'gauge'},
    {'name': 'download_bytes',
     'description': 'Speedtest Download Bytes in bytes.',
     'type': 'gauge'},
    {'name': 'download_elapsed',
     'description': 'Speedtest Download Speed in bit/s',
     'type': 'gauge'},
    ...
    {'name': 'upload_bandwidth',
     'description': 'Speedtest Upload Bandwith in bits per second (bps).',
     'type': 'gauge'},
    {'name': 'upload_bytes',
